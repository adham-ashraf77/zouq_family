        ...
        setState(() {
          newOrders.add(
            Order(
              ...
              appMoney: data[i]['app_money'],
              familyMoney: data[i]['family_money'],
              usingCashFees: data[i]['using_cash_fees'],
              discountMoney: data[i]['discount_money'],
              deliveryMoney: data[i]['delivery_money'],
      ...
      for (int i = 0; i < x.length; i++) {
        setState(() {
          oldOrders.add(Order(
            ...
            appMoney: x[i]['app_money'],
            familyMoney: x[i]['family_money'],
            usingCashFees: x[i]['using_cash_fees'],
            discountMoney: x[i]['discount_money'],
            deliveryMoney: x[i]['delivery_money'],
            rate: 0,
